pipeline {
  agent {
    kubernetes {
      label 'ruby-driver-bblfsh-performance'
      defaultContainer 'ruby-driver-bblfsh-performance'
      yaml """
spec:
  nodeSelector:
  ...
  containers:
  - name: ruby-driver-bblfsh-performance
...
"""
  ...
  environment {
    DRIVER_LANGUAGE = "ruby"
    DRIVER_REPO = "https://github.com/bblfsh/ruby-driver.git"
