...
var (
	...
	Options          = ann.HasInternalType("options")
	Or               = ann.HasInternalType("or")
	OrAsgn           = ann.HasInternalType("or_asgn")
	Pair             = ann.HasInternalType("pair")
	PairFirst        = ann.HasInternalType("_1")
	PairSecond       = ann.HasInternalType("_2")
	...
	Values           = ann.HasInternalType("values")
